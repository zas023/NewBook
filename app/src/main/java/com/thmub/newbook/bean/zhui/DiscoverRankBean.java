...
public class DiscoverRankBean {
    ...
    private boolean ok;
    private List<RankBean> female;
    private List<RankBean> male;
    ...
    public List<RankBean> getFemale() {
        return female;
    }

    public void setFemale(List<RankBean> female) {
        this.female = female;
    }


    public List<RankBean> getMale() {
        return male;
    }

    public void setMale(List<RankBean> male) {
        this.male = male;
    }
