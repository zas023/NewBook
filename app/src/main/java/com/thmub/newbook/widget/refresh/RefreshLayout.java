package com.thmub.newbook.widget.refresh;
...
public abstract class RefreshLayout extends FrameLayout {
    ...
    private void initAttrs(AttributeSet attrs){
        ...
        mEmptyViewId = typedArray.getResourceId(R.styleable.RefreshLayout_layout_refresh_empty,R.layout.view_refresh_empty);
        mErrorViewId = typedArray.getResourceId(R.styleable.RefreshLayout_layout_refresh_error,R.layout.view_refresh_net_error);
        mLoadingViewId = typedArray.getResourceId(R.styleable.RefreshLayout_layout_refresh_loading,R.layout.view_refresh_loading);
    }
