...
import com.thmub.newbook.ui.adapter.holder.StoreBookListHolder;

/**
 * Created by Zhouas666 on 2019-04-13
 * Github: https://github.com/zas023
 */
public class StoreBookListAdapter extends QuickAdapter<StoreNodeBookBean> {
    @Override
    protected IViewHolder<StoreNodeBookBean> createViewHolder(int viewType) {
        return new StoreBookListHolder();
    }
}
