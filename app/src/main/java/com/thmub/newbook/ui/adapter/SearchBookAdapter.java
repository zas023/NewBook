...
public class SearchBookAdapter extends QuickAdapter<BookSearchBean> {
    ...
    public void addItems(List<BookSearchBean> values, String keyword) {
        synchronized (this) {
            ...
            Collections.sort(mList, (o1, o2) -> {
                if (o1.getTitle().equals(keyword))
                    return -1;
                if (o2.getTitle().equals(keyword))
                    return 1;
                if (o1.getAuthor().equals(keyword))
                    return -1;
                if (o2.getAuthor().equals(keyword))
                    return 1;
            ...
            //更新
            activityRef.get().runOnUiThread(() -> notifyDataSetChanged());
        }
    }
}
