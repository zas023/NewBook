...
public abstract class BaseRecyclerAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public void addItems(List<T> values){
        mList.addAll(values);
        //notifyDataSetChanged();
        //解决java.lang.IllegalStateException: Cannot call this method while RecyclerView is
        //    computing a layout or scrolling androidx.recyclerview.widget.RecyclerView
        //https://www.jianshu.com/p/353d401fbd99
